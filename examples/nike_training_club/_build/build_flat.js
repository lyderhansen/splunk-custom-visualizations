...
vizDirs.forEach(function(vizName) {
    ...
    var output = [
        ...
        '        hexToRgb:hexToRgb, severityColor:severityColor, fmtNum:fmtNum,',
        '        roundRect:roundRect, drawPanel:drawPanel, drawHGrid:drawHGrid,',
        '        parseColors:parseColors, parseInts:parseInts, FONTS:FONTS,',
        '        getNS:getNS, getOption:getOption, parseNum:parseNum,',
        '        loadFonts:loadFonts, setupCanvas:setupCanvas };',
        '})();',
        '',
        '// ── Viz source ──',
        src,
